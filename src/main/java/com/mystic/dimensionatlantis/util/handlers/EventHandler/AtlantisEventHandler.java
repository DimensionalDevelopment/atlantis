...
public class AtlantisEventHandler {
    ...
    public static void onDeath(LivingDeathEvent event) {
    	...
    	if (event.getEntity() instanceof EntityElderGuardian && event.getEntity().world.getEntitiesWithinAABB(EntityElderGuardian.class, event.getEntity().getEntityBoundingBox().expand(100, 100, 100)).isEmpty()){
