...
public class EnenmomyTileEntity extends BlockEntity implements IAnimatable {
    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);
    private final AnimationController<EnenmomyTileEntity> mainController = new AnimationController<EnenmomyTileEntity>(this, "enenmomycontroller", 0, this::predicate);
