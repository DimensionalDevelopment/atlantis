...
{
    @Override
    public ResourceLocation getModelLocation(BlueLilyTileEntity object)
    {
        return new ResourceLocation(Reference.MODID, "geo/flower_1.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(BlueLilyTileEntity object)
    {
        return new ResourceLocation(Reference.MODID, "textures/block/blue_lily.png");
    }

    @Override
    public ResourceLocation getAnimationFileLocation(BlueLilyTileEntity object)
    {
