...
public class UnderwaterShroomBlock extends PlantBlock implements BlockEntityProvider, Waterloggable {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return TileRegistry.UNDERWATER_SHROOM_TILE.instantiate(pos, state);
    }
}
