...
public class AtlanteanSapling extends SaplingBlock implements Waterloggable {

    public static final Property<Boolean> WATERLOGGED = Properties.WATERLOGGED;

    public AtlanteanSapling(SaplingGenerator generator, Settings settings) {
        ...
        this.getDefaultState().with(WATERLOGGED, Boolean.TRUE).with(STAGE, 0);
    }
