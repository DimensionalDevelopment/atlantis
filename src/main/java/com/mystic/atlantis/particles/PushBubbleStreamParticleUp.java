...
@OnlyIn(Dist.CLIENT)
public class PushBubbleStreamParticleUp extends TextureSheetParticle {

   private final Direction direction;

   PushBubbleStreamParticleUp(ClientLevel clientWorld, double x, double y, double z, Direction direction) {
   ...
   public static class Factory implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(SimpleParticleType defaultParticleType, ClientLevel clientWorld, double d, double e, double f, double g, double h, double i) {
         PushBubbleStreamParticleUp pushBubbleStreamParticle = new PushBubbleStreamParticleUp(clientWorld, d, e, f, Direction.UP);
