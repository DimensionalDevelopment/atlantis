...
@OnlyIn(Dist.CLIENT)
public class PushBubbleStreamParticleDown extends TextureSheetParticle {

   private final Direction direction;

   PushBubbleStreamParticleDown(ClientLevel clientWorld, double x, double y, double z, Direction direction) {
   ...
   public static class Factory implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(SimpleParticleType defaultParticleType, ClientLevel clientWorld, double d, double e, double f, double g, double h, double i) {
         PushBubbleStreamParticleDown pushBubbleStreamParticle = new PushBubbleStreamParticleDown(clientWorld, d, e, f, Direction.DOWN);
