...
@OnlyIn(Dist.CLIENT)
public class PushBubbleStreamParticleEast extends TextureSheetParticle {

   private final Direction direction;

   PushBubbleStreamParticleEast(ClientLevel clientWorld, double x, double y, double z, Direction direction) {
   ...
   public static class Factory implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(SimpleParticleType defaultParticleType, ClientLevel clientWorld, double d, double e, double f, double g, double h, double i) {
         PushBubbleStreamParticleEast pushBubbleStreamParticle = new PushBubbleStreamParticleEast(clientWorld, d, e, f, Direction.EAST);
