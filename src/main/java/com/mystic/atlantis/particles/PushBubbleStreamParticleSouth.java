...
@OnlyIn(Dist.CLIENT)
public class PushBubbleStreamParticleSouth extends TextureSheetParticle {

   private final Direction direction;

   PushBubbleStreamParticleSouth(ClientLevel clientWorld, double x, double y, double z, Direction direction) {
   ...
   public static class Factory implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(SimpleParticleType defaultParticleType, ClientLevel clientWorld, double d, double e, double f, double g, double h, double i) {
         PushBubbleStreamParticleSouth pushBubbleStreamParticle = new PushBubbleStreamParticleSouth(clientWorld, d, e, f, Direction.SOUTH);
