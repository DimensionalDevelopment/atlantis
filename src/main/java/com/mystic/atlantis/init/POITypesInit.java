...
public class POITypesInit extends PoiTypes {
    ...
    public static final RegistryObject<PoiType> ATLANTEAN_PORTAL = POI.register("atlantean_portal" , () -> new PoiType(getBlockStates(BlockInit.ATLANTEAN_PORTAL.get()), 0, 1));
