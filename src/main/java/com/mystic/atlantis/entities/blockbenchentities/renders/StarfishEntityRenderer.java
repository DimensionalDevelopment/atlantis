...
public class StarfishEntityRenderer extends GeoEntityRenderer<StarfishEntity> {
    ...
    public StarfishEntityRenderer(EntityRendererProvider.Context renderManager, AnimatedGeoModel<StarfishEntity> modelProvider) {
        super(renderManager, modelProvider);
    }

    @Override
    public void render(StarfishEntity mobEntity, float f, float g, PoseStack matrixStack, MultiBufferSource vertexConsumerProvider, int i) {
    ...
    private <E extends Entity> void method_4073(StarfishEntity entity, float tickDelta, PoseStack matrices, MultiBufferSource provider, E holdingEntity) {
        matrices.pushPose();
