...
public class Jellyfish2EntityRenderer extends GeoEntityRenderer<Jellyfish2Entity> {
    ...
    public Jellyfish2EntityRenderer(EntityRendererProvider.Context renderManager, AnimatedGeoModel<Jellyfish2Entity> modelProvider) {
    ...
    private void renderStuff(Jellyfish2Entity entity, float entityYaw, float partialTicks, PoseStack stack,
        ...
        if (getGeoModelProvider() instanceof IAnimatableModel) {
            ((IAnimatableModel<Jellyfish2Entity>) getGeoModelProvider()).setCustomAnimations(entity, this.getInstanceId(entity), predicate);
        }
