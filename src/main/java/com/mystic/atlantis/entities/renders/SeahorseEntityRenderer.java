...
//            for (GeoRenderLayer<SeahorseEntity> layerRenderer : this.getRenderLayers()) {
...
//        Vec3 vec3d2 = entity.getLeashOffset(0f);
...
//        float n = (float) (Mth.fastInvSqrt(j * j + l * l) * 0.025F / 2.0F);
//        float o = l * n;
//        float p = j * n;
