...
public class NymphBoatRenderer extends EntityRenderer<NymphBoatEntity> {
    ...
    public NymphBoatRenderer(EntityRendererProvider.Context p_173936_) {
        ...
        model = new NymphBoatModel(p_173936_.bakeLayer(ModelLayers.createBoatModelName(Boat.Type.OAK)));
    }
    ...
    public @NotNull ResourceLocation getTextureLocation(NymphBoatEntity pEntity) {
        return new ResourceLocation(Reference.MODID, "textures/entity/boat/nymph.png");
    }
