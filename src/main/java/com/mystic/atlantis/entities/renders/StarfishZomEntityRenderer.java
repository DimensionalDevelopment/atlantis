...
public class StarfishZomEntityRenderer extends GeoEntityRenderer<StarfishZomEntity> {

    public StarfishZomEntityRenderer(EntityRendererProvider.Context renderManager, AnimatedGeoModel<StarfishZomEntity> modelProvider) {
        super(renderManager, modelProvider);
    }

    @Override
    public void render(StarfishZomEntity mobEntity, float f, float g, PoseStack matrixStack, MultiBufferSource vertexConsumerProvider, int i) {
    ...
    private <E extends Entity> void method_4073(StarfishZomEntity entity, float tickDelta, PoseStack matrices, MultiBufferSource provider, E holdingEntity) {
        matrices.pushPose();
