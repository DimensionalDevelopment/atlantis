...
public class AquaielJellyfishEntityModel extends GeoModel<AquaielJellyfishEntity> {
    @Override
    public ResourceLocation getModelResource(AquaielJellyfishEntity entity) {
    ...
    @Override
    public ResourceLocation getTextureResource(AquaielJellyfishEntity entity) {
        if (entity.getVariant() == 1) {
    ...
    @Override
    public ResourceLocation getAnimationResource(AquaielJellyfishEntity entity) {
        if (entity.getVariant() == 1) {
