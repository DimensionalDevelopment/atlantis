...
public class GardenFoliageFeature extends Feature<NoneFeatureConfiguration> {
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> config) {
        ...
        BlockPos pos = config.origin();
            BlockState blockstate = switch (rand.nextInt(5)) {
                case 1 -> BlockInit.TUBER_UP.get().defaultBlockState();
                case 2 -> BlockInit.ANEMONE.get().defaultBlockState();
                case 3 -> BlockInit.BLUE_LILY.get().defaultBlockState();
                case 4 -> BlockInit.BURNT_DEEP.get().defaultBlockState();
                default -> BlockInit.SEASHROOM.get().defaultBlockState();
            };
