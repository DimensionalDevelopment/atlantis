...
public class NymphBoatItem extends Item {
    private static final Predicate<Entity> RIDERS;

    public NymphBoatItem(Properties settings) {
        super(settings);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level world, Player user, InteractionHand hand) {
        ...
        if (hitResult.getType() != HitResult.Type.BLOCK) {
            ...
            if (!(world.getBlockState(blockPos).getBlock() instanceof LiquidBlock)) {
                ...
                NymphBoatEntity boatEntity = new NymphBoatEntity(AtlantisEntityInit.NYMPH_BOAT.get(), world);
