...
public class WorldGenAlgae implements IWorldGenerator
{
    public final WorldGeneratorAlgae ALGAE = new WorldGeneratorAlgae();
    ...
    private void generatePlant(WorldGeneratorAlgae generator, World world, Random random, int chunkX, int chunkZ, int chance)
    {
