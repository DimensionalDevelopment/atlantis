...
public class JetstreamWaterFluid extends FlowableFluid{
    ...
    protected BlockState toBlockState(FluidState fluidState) {
        return FluidInit.JETSTREAM_WATER.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(fluidState));
    }
