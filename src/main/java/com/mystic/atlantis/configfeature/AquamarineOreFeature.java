...
public class AquamarineOreFeature extends Feature<AtlantisOreFeatureConfig> {
    ...
    public boolean generate(ISeedReader reader, ChunkGenerator generator, Random random, BlockPos pos, AtlantisOreFeatureConfig config) {
    ...
    protected boolean func_207803_a(IWorld world, Random random, AtlantisOreFeatureConfig config, double v, double v1, double v2, double v3, double v4, double v5, int i4, int i5, int i6, int i7, int i8) {
        int i = 0;
