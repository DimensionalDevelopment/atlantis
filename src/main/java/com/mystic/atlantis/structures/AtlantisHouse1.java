...
public class AtlantisHouse1 extends StructureFeature<DefaultFeatureConfig> {

    public AtlantisHouse1(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }

    @Override
    public StructureStartFactory<DefaultFeatureConfig> getStructureStartFactory() {
        return AtlantisHouse1.Start::new;
    }
    ...
    public static class Start extends StructureStart<DefaultFeatureConfig> {
        ...
        public void init(DynamicRegistryManager dynamicRegistryManager, ChunkGenerator chunkGenerator, StructureManager templateManagerIn, ChunkPos pos, Biome biomeIn, DefaultFeatureConfig config, HeightLimitView world) {
            ...
            StructurePoolBasedGenerator.generate(
                    ...
                    new StructurePoolFeatureConfig(() -> dynamicRegistryManager.get(Registry.STRUCTURE_POOL_KEY).get(new Identifier(Reference.MODID, "atlantean_house_1/start_pool")), 10), PoolStructurePiece::new, chunkGenerator, templateManagerIn ,blockpos, (this), this.random, false, false, world);
