...
public class AtlantisTower extends StructureFeature<JigsawConfiguration> {
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        JigsawConfiguration newConfig = new JigsawConfiguration(context.registryAccess().registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                .getOrCreateHolder(ResourceKey.create(Registry.TEMPLATE_POOL_REGISTRY, new ResourceLocation(Reference.MODID, "atlantean_tower/start_pool"))),
                10
        );
