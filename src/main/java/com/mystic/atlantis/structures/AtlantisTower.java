...
public class AtlantisTower extends StructureFeature<DefaultFeatureConfig> {

    public AtlantisTower(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }

    @Override
    public StructureStartFactory<DefaultFeatureConfig> getStructureStartFactory() {
        return AtlantisTower.Start::new;
    }
    ...
    public static class Start extends StructureStart<DefaultFeatureConfig> {
        ...
        public void init(DynamicRegistryManager dynamicRegistryManager, ChunkGenerator chunkGenerator, StructureManager templateManagerIn, ChunkPos pos, Biome biomeIn, DefaultFeatureConfig config, HeightLimitView world) {
            ...
            StructurePoolBasedGenerator.generate(
                    ...
                    new StructurePoolFeatureConfig(() -> dynamicRegistryManager.get(Registry.STRUCTURE_POOL_KEY).get(new Identifier(Reference.MODID, "atlantean_tower/start_pool")), 10), PoolStructurePiece::new, chunkGenerator, templateManagerIn ,blockpos, (this), this.random, false, false, world);
