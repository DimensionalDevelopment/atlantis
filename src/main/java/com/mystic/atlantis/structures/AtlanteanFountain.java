    ...
    public static class Start extends StructureStart<DefaultFeatureConfig> {
        ...
        public void func_230364_a_(DynamicRegistryManager dynamicRegistryManager, ChunkGenerator chunkGenerator, StructureManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, DefaultFeatureConfig config) {
            ...
            StructurePoolBasedGenerator.method_30419(
                    ...
                    new StructurePoolFeatureConfig(() -> dynamicRegistryManager.get(Registry.TEMPLATE_POOL_WORLDGEN).get(new Identifier(Reference.MODID, "atlantean_fountain/start_pool")), 10), PoolStructurePiece::new, chunkGenerator, templateManagerIn, blockpos, this.children, this.random, false, false);
