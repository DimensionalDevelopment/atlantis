...
public class OysterStructure extends StructureFeature<JigsawConfiguration> {

    public OysterStructure(Codec<JigsawConfiguration> codec) {
        super(codec, OysterStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
